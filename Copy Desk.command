#!/bin/bash
# ─────────────────────────────────────────────────────────────────────────
# Double-click this to open Copy Desk — live-site copy edits, one at a time.
#
# It starts a tiny local helper, waits for it to be ready, then opens the page
...
if [ -z "$opened" ]; then
  echo ""
  echo "✗  Copy Desk couldn't start — see the message above."
  echo "   (Usually: it's already open in another window, or you're offline.)"
  echo ""
...
echo ""
echo "─────────────────────────────────────────────────────────────"
echo "  Copy Desk is open in your browser."
